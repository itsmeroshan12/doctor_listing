...
const DoctorDetails = () => {
  ...
  if (!doctor) {
    return <div className="text-center my-5 text-danger">Doctor not found.</div>;
  }
            ...
            <div className="row">
              ...
              <div className={`col-md-8 col-sm-12 p-3 ${styles.card}`}>
                ...
                <div className={styles.infoText}>
                  <FaMapMarkerAlt className="me-2" /> {doctor.address}, {doctor.area}
                </div>
                <div className={styles.infoText}>
                ...
                <div className="d-flex gap-2 mt-3 flex-wrap">
                  <a
                    ...
                    href={`https://wa.me/91${doctor.mobile}`}
                    target="_blank"
