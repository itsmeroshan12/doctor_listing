...
const ClinicList = () => {
  ...
  return (
    ...
    <div className="container mt-4">
      ...
      {loading ? (
        [...Array(3)].map((_, index) => (
          <div key={index} className="clinic-listing shimmer mb-3 d-flex align-items-center justify-content-center">
        ...
        currentClinics.map((clinic) => (
          <div key={clinic.id} className="clinic-listing mb-4 d-flex align-items-center justify-content-center animate-fade-in">
            <img
            ...
            <div className="flex-grow-1">
              ...
              <div className={`row g-2 ${isMobile ? 'flex-nowrap overflow-auto mobile-button-row' : ''}`}>
                <div className="col-12 col-md">
                  <button
                    className="btn btn-sm btn-outline-primary w-100 shadow-sm rounded-pill animate-button"
                    onClick={() => {
                      window.location.href = `/clinics/${clinic.area}/${clinic.type}/${clinic.slug}`;
                    }}
                  >
                    View More
                  </button>
                ...
                <div className="col-12 col-md">
                  <a
                    className="btn btn-sm btn-success w-100 shadow-sm rounded-pill animate-button"
                ...
                <div className="col-12 col-md">
                  <a
                    className="btn btn-sm btn-outline-secondary w-100 shadow-sm rounded-pill animate-button"
      ...
      <div className="d-flex justify-content-center py-4">
        {Array.from({ length: totalPages }, (_, idx) => (
          <button
            key={idx}
            className={`btn btn-sm mx-1 ${currentPage === idx + 1 ? 'btn-primary' : 'btn-outline-primary'}`}
